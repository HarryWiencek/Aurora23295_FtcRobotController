...
@Config
@Autonomous(name = "SixBallBlue", group = "ChoppedAutos")
public class SixBallBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // ---------------------- Initialize ----------------------
        Pose2d initialPose = new Pose2d(47.5, 12, Math.toRadians(180));
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(39.5, 13, Math.toRadians(201)))
                .splineTo(new Vector2d(-36, 26), Math.toRadians(160))
                .turn(Math.toRadians(-70));

        TrajectoryActionBuilder tab3 = drive.actionBuilder(new Pose2d(-36, 26, Math.toRadians(90)))
                .lineToY(50, collectingBallsVel, collectingBallsAccel);

        TrajectoryActionBuilder tab4 = drive.actionBuilder(new Pose2d(-36, 50, Math.toRadians(90)))
                .setReversed(true)
                .splineTo(new Vector2d(-53, 13), Math.toRadians(-339));

        TrajectoryActionBuilder tab5 = drive.actionBuilder(new Pose2d(39.5, 13, Math.toRadians(201)))
                .setReversed(false)
