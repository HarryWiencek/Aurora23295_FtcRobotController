...
@TeleOp(name = "PIDAndDriveOpMode", group = "OpModes")
public class PIDAndDriveOpMode extends OpMode {
    ...
    /**PID CONSTANTS**/
    final double pidP = 5;
    final double pidI = 0.0;
    final double pidD = 0.0;
    ...
    public void start() {
        ...
        //Restarts Timer
        matchTimer.reset();
        //Prepares Controller Vibration Feature
    ...
    public void loop() {
        ...
        //--Keeps Robot still while recentering ODO--
        if (recenterTime > 0) {
